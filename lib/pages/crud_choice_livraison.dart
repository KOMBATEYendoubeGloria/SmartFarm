...
import 'livraison_list_page.dart';

class CrudChoiceLivraison extends StatelessWidget {
  const CrudChoiceLivraison({super.key});
        ...
        child: Column(
          children: [
            _buildButton(
              ...
              page: const AddLivraisonPage(),
            ),
            const SizedBox(height: 20),
            _buildButton(
              context,
              icon: Icons.list_alt,
              text: "Voir / Modifier / Supprimer",
